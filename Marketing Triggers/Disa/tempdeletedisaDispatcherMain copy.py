...
WEBHOOK_URL = "https://gs.budy.bot/external/services/consultant/webhook/v2/run/actsLife/276f9b05648242148801e42ec70d2673"
DELAY_SECONDS = 5 * 60  # 5 minutes

# Community IDs to dispatch for
COMMUNITY_IDS = ["24", "25", "27", "31", "34", "63", "58","54"]
...
def main() -> None:
    # Start time: Feb 26, 2026 at 7:00 AM Pacific (local Mac time)
    target = datetime(2026, 2, 26, 7, 0, 0)
